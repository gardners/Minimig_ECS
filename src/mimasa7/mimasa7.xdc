...
#                                               Header P12                                                        #
###################################################################################################################
set_property -dict  { PACKAGE_PIN "J20"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12z[0]}];                       # IO_L11P_T1_SRCC_15            Sch = GPIO_1_P
set_property -dict  { PACKAGE_PIN "J21"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12z[1]}];                       # IO_L11N_T1_SRCC_15            Sch = GPIO_1_N
set_property -dict  { PACKAGE_PIN "K21"   IOSTANDARD TMDS_33   SLEW SLOW } [get_ports {P12[2]}];                       # IO_L9P_T1_DQS_AD3P_15         Sch = GPIO_2_P
set_property -dict  { PACKAGE_PIN "K22"   IOSTANDARD TMDS_33   SLEW SLOW } [get_ports {P12[3]}];                       # IO_L9N_T1_DQS_AD3N_15         Sch = GPIO_2_N
set_property -dict  { PACKAGE_PIN "H20"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[4]}];                       # IO_L8P_T1_AD10P_15            Sch = GPIO_3_P
set_property -dict  { PACKAGE_PIN "G20"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[5]}];                       # IO_L8N_T1_AD10N_15            Sch = GPIO_3_N
set_property -dict  { PACKAGE_PIN "J19"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[6]}];                       # IO_L12P_T1_MRCC_15            Sch = GPIO_4_P
set_property -dict  { PACKAGE_PIN "H19"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[7]}];                       # IO_L12N_T1_MRCC_15            Sch = GPIO_4_N
set_property -dict  { PACKAGE_PIN "J22"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[8]}];                   `   # IO_L7P_T1_AD2P_15             Sch = GPIO_5_P
set_property -dict  { PACKAGE_PIN "H22"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[9]}];                       # IO_L7N_T1_AD2N_15             Sch = GPIO_5_N
set_property -dict  { PACKAGE_PIN "K18"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[10]}];                      # IO_L13P_T2_MRCC_15            Sch = GPIO_6_P
set_property -dict  { PACKAGE_PIN "K19"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[11]}];                      # IO_L13N_T2_MRCC_15            Sch = GPIO_6_N
set_property -dict  { PACKAGE_PIN "L19"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[12]}];                      # IO_L14P_T2_SRCC_15            Sch = GPIO_7_P
set_property -dict  { PACKAGE_PIN "L20"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[13]}];                      # IO_L14N_T2_SRCC_15            Sch = GPIO_7_N
set_property -dict  { PACKAGE_PIN "M21"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[14]}];                      # IO_L10P_T1_AD11P_15           Sch = GPIO_8_P
set_property -dict  { PACKAGE_PIN "L21"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[15]}];                      # IO_L10N_T1_AD11N_15           Sch = GPIO_8_N
set_property -dict  { PACKAGE_PIN "N22"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[16]}];                      # IO_L15P_T2_DQS_15             Sch = GPIO_9_P
set_property -dict  { PACKAGE_PIN "M22"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[17]}];                      # IO_L15N_T2_DQS_ADV_B_15       Sch = GPIO_9_N
set_property -dict  { PACKAGE_PIN "N20"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[18]}];                      # IO_L18P_T2_A24_15             Sch = GPIO_10_P
set_property -dict  { PACKAGE_PIN "M20"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[19]}];                      # IO_L18N_T2_A23_15             Sch = GPIO_10_N
set_property -dict  { PACKAGE_PIN "M18"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[20]}];                      # IO_L16P_T2_A28_15             Sch = GPIO_11_P
set_property -dict  { PACKAGE_PIN "L18"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[21]}];                      # IO_L16N_T2_A27_15             Sch = GPIO_11_N
set_property -dict  { PACKAGE_PIN "N18"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[22]}];                      # IO_L17P_T2_A26_15             Sch = GPIO_12_P
set_property -dict  { PACKAGE_PIN "N19"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[23]}];                      # IO_L17N_T2_A25_15             Sch = GPIO_12_N
set_property -dict  { PACKAGE_PIN "H17"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[24]}];                      # IO_L6P_T0_15                  Sch = GPIO_13_P
set_property -dict  { PACKAGE_PIN "H18"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[25]}];                      # IO_L6N_T0_VREF_15             Sch = GPIO_13_N
set_property -dict  { PACKAGE_PIN "G17"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[26]}];                      # IO_L4P_T0_15                  Sch = GPIO_14_P
set_property -dict  { PACKAGE_PIN "G18"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[27]}];                      # IO_L4N_T0_15                  Sch = GPIO_14_N
set_property -dict  { PACKAGE_PIN "G15"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[28]}];                      # IO_L2P_T0_AD8P_15             Sch = GPIO_15_P
set_property -dict  { PACKAGE_PIN "G16"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[29]}];                      # IO_L2N_T0_AD8N_15             Sch = GPIO_15_N
set_property -dict  { PACKAGE_PIN "J15"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[30]}];                      # IO_L5P_T0_AD9P_15             Sch = GPIO_16_P
set_property -dict  { PACKAGE_PIN "H15"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[31]}];                      # IO_L5N_T0_AD9N_15             Sch = GPIO_16_N
set_property -dict  { PACKAGE_PIN "K13"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[32]}];                      # IO_L19P_T3_A22_15             Sch = GPIO_17_P
set_property -dict  { PACKAGE_PIN "K14"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[33]}];                      # IO_L19N_T3_A21_VREF_15        Sch = GPIO_17_N
set_property -dict  { PACKAGE_PIN "M13"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[34]}];                      # IO_L20P_T3_A20_15             Sch = GPIO_18_P
set_property -dict  { PACKAGE_PIN "L13"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[35]}];                      # IO_L20N_T3_A19_15             Sch = GPIO_18_N
set_property -dict  { PACKAGE_PIN "J14"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[36]}];                      # IO_L3P_T0_DQS_AD1P_15         Sch = GPIO_19_P
set_property -dict  { PACKAGE_PIN "H14"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[37]}];                      # IO_L3N_T0_DQS_AD1N_15         Sch = GPIO_19_N
set_property -dict  { PACKAGE_PIN "H13"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[38]}];                      # IO_L1P_T0_AD0P_15             Sch = GPIO_20_P
set_property -dict  { PACKAGE_PIN "G13"   IOSTANDARD TMDS_33   SLEW FAST } [get_ports {P12[39]}];                      # IO_L1N_T0_AD0N_15             Sch = GPIO_20_N
